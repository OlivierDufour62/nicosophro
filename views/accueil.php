...
<section id="part2" class="background-brown space-mb100 w-100 container-fluid d-flex justify-content-center">
    <div class="w-80 col-12 row d-flex justify-content-center inspace-p25">
        <div class="d-flex justify-content-end col-3 img-fluid">
            <img src="./public/assets/img/nico.jpg" alt="Nicolas Mokhtari" class="img-fluid b-radius-tl-mr">
        </div>
        <div class="col-7 d-flex align-items-center">
            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="./public/assets/img/bureau.jpg" class="d-block w-100" alt="bureau1">
                    </div>
                    <div class="carousel-item">
                        <img src="./public/assets/img/bureau.jpg" class="d-block w-100" alt="bureau2">
                    </div>
                    <div class="carousel-item">
                        <img src="./public/assets/img/bureau.jpg" class="d-block w-100" alt="bureau3">
                    </div>
                </div>
    ...
    <div class="w-50 row d-flex justify-content-around space-t25 space-mb25">
        <div class="col-2 border bg-grey shadow-lg">
            <div class="inspace-p25">
                <img src="./public/assets/img/background-916223.jpg" class="img-fluid" alt="">
            </div>
